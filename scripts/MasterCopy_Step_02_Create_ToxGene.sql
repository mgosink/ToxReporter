...
DROP DATABASE IF EXISTS `TOXREPORTER_DBNAME`;

CREATE DATABASE `TOXREPORTER_DBNAME`;

USE `TOXREPORTER_DBNAME`;
...
-- -----------------------------------------------------
GRANT ALL ON TABLE `TOXREPORTER_DBNAME`.* to 'ToxGene_Admin'@'%' IDENTIFIED BY 'ToxReporter_Admin';
GRANT ALL ON TABLE `TOXREPORTER_DBNAME`.* to 'ToxGene_Admin'@'localhost' IDENTIFIED BY 'ToxReporter_Admin';

GRANT SELECT ON TABLE `TOXREPORTER_DBNAME`.* to 'ToxGene_Guest'@'%' IDENTIFIED BY 'guest';
GRANT SELECT ON TABLE `TOXREPORTER_DBNAME`.* to 'ToxGene_Guest'@'localhost' IDENTIFIED BY 'guest';
