...
%MiscVariables = (
'ADMINISTRATOR_NAME'		=>	'ToxGene Administrator',
'ADMINISTRATOR_EMAIL'	=>	'Mark.M.Gosink@Pfizer.com',
'TOXGENE_USER'				=>	'<username>',
'TOXGENE_PSWD'				=>	'<password>',
'DATABASE_TYPE'			=>	'DBI:mysql',
'DATABASE_NAME'			=>	'TOXREPORTER_DBNAME',
'DATABASE_HOST'			=>	'<host>',
'DATABASE_PORT'			=>	'<port>',
'BASE_TOX_SYS_ID'			=>	'1',
...
%SetupFiles = (
	'GENE2PUBMED'  	=> 	'/cssi/cbrdb/refseqreffiles/online/gene2pubmed',
	'HOMOLOGENE' 		=> 	'/cssi/cbrdb/homologene/online/homologene.data',
	'GENEINFO'  		=> 	'/cssi/cbrdb/refseqreffiles/online/gene_info',
	'MIM2GENE' 			=> 	'/cssi/cbrdb/refseqreffiles/online/mim2gene_medgen',
	'GENE2GO' 			=> 	'/cssi/cbrdb/refseqreffiles/online/gene2go',
	'PUBMED_CITED' 	=> 	''
);
